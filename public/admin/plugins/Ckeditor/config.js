...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.plugins = 'dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,button,panelbutton,panel,' +
        ...
        'richcombo,font,forms,format,horizontalrule,htmlwriter,iframe,wysiwygarea,image,indent,indentblock,indentlist,smiley,justify,' +
        ...
        'uploadwidget,uploadimage,bootstrapTabs,btgrid,chart,colorinput,computedfont,contents,zoom,youtube,ckawesome,googlesearch,googledocs,' +
        'ckeditor-gwf-plugin,html5video';
